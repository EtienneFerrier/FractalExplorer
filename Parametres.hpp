...
#define NB_ITERATIONS 250			// Nombre d’itérations maximal
#define GPU 1						// 1 if using GPU, 0 if using CPU
#define BIG_FLOAT_SIZE 10			// Le nombre de bits sur lesquels on code un grand flottant, 0 pour utiliser les floats normaux
